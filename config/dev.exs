...
config :gigalixir_getting_started_phx_1_3_rc_2, GigalixirGettingStartedPhx13Rc2.Web.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r{priv/gettext/.*(po)$},
      ~r{lib/gigalixir_getting_started_phx_1_3_rc_2/web/views/.*(ex)$},
      ~r{lib/gigalixir_getting_started_phx_1_3_rc_2/web/templates/.*(eex)$}
    ]
  ]
...
config :gigalixir_getting_started_phx_1_3_rc_2, GigalixirGettingStartedPhx13Rc2.Repo,
  ...
  username: "postgres",
  password: "postgres",
  database: "gigalixir_getting_started_phx_1_3_rc_2_dev",
  hostname: "localhost",
  pool_size: 10
