...
# GigalixirGettingStartedPhx13Rc2.Web.Endpoint.load_from_system_env/1 dynamically.
...
# start per endpoint:
#
#     config :gigalixir_getting_started_phx_1_3_rc_2, GigalixirGettingStartedPhx13Rc2.Web.Endpoint, server: true
#
